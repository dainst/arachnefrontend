...
.config(['$stateProvider', '$urlRouterProvider', '$locationProvider', '$compileProvider',
	function($stateProvider, $urlRouterProvider, $locationProvider, $compileProvider) {
		...
		$stateProvider
			...
			.state('catalog', { url: '/catalog/:id', templateUrl: 'partials/catalog.html', data: { pageTitle: title }})
			.state('catalog.entry', { url: '/:entryId', templateUrl: 'partials/catalog.html', data: { pageTitle: title }})
