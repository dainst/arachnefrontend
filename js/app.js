...
.config(['$stateProvider', '$urlRouterProvider', '$locationProvider', '$compileProvider', '$resourceProvider',
	function($stateProvider, $urlRouterProvider, $locationProvider, $compileProvider, $resourceProvider) {
		...
		$stateProvider
			...
			.state('catalog', { url: '/catalog/:id?view', templateUrl: 'partials/catalog.html', data: { pageTitle: title }})
			.state('catalog.entry', { url: '/:entryId?view', templateUrl: 'partials/catalog.html', data: { pageTitle: title }})
			...
			.state('map', { url: '/map?q&fq', templateUrl: 'partials/map/map.html', data: { pageTitle: title }})
