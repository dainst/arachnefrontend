...
transl8['en'] = {
    ...
    "catalog_description": "Catalog text",
    ...
    "data_export_to_huge_and_will_be_sent_by_mail": "This export is huge and will take us a while. We'll send you an email when we are ready.",
    "data_export_to_huge_and_not_logged_in": "This export is huge and wen need you to be logged in for that.",
    "data_export_io_error": "IO-Error",
    "data_export_no_admin": "You have to be an admin to do this.",
    "data_export_not_found": "File not Found",
    "data_export_stack_full": "The data-export-stack is full unfortunately. Please try it again later.",
    "ui_data_export_none": "There is no data-export in your list.",
    "ui_restore_call": "Restore Source",
    "ui_catalog": "Catalog",
    "ui_searchResult": "Search Result",
    "ui_to": "to",
    "data_export_to_huge": "This export is huge.",
