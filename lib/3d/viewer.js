...
function init() {
    ...
    if (id == null) {
        ...
        if (isNumeric(id)) {
            ...
            var modelUrl = 'http://crazyhorse.archaeologie.uni-koeln.de/arachnedataservice/model/' + id;
            var materialUrl = 'http://crazyhorse.archaeologie.uni-koeln.de/arachnedataservice/model/material/' + id;
