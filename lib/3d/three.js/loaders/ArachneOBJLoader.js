 ...
 * @author Reimar Grabowski (added function loadFromFile to load assets via the HTML5 file API)
 */
...
THREE.OBJLoader.prototype = {
	...
	loadFromFile: function(file, onLoad) {
        var scope = this;
	...
	parse: function ( text ) {
		...
		for ( var i = 0; i < lines.length; i ++ ) {
		    /*if (i % 1000 == 0) {
                this.progressCallback(i/lines.length*100+'%');
            }*/
